...
DEBUG_MODE = os.environ.get('DJANGO_DEBUG_MODE', False)
DEBUG = False
if DEBUG_MODE == 'True':
    DEBUG = True
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Cosmos Backend API',
    'DESCRIPTION': 'Show and store transactions and stock/bond prices',
    'VERSION': '1.0.0',
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'http://127.0.0.1:3000',
    'https://cosmos-capstone.github.io',
]